      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              IconButton(
                onPressed: widget.actionHandler.onPromptTemplatesBackRequested,
              ...
              ActionButton(
                ...
                onPressed:
                    widget.actionHandler.onPromptTemplatesRefreshRequested,
              ),
            ],
          ),
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            widget.actionHandler
                                .onPromptTemplatesTemplateSelected(item.id);
                          },
                        );
                      },
                    ),
                        ...
                        children: [
                          SectionHeading(
                            ...
                            subtitle: widget.viewData.editor.relativePath
                                ...
                                : (widget.viewData.editor.isBuiltin
                                      ? '内置模板'
                                      : '新模板'),
                          ),
                          ...
                          Wrap(
                            ...
                            children: [
                              ActionButton(
                                ...
                                onPressed: () {
                                  widget.actionHandler
                                      .onPromptTemplatesPreviewRequested(
                                        _request(),
                                      );
                                },
                              ),
                              ActionButton(
                                ...
                                onPressed: () {
                                  widget.actionHandler
                                      .onPromptTemplatesSaveRequested(
                                        _request(),
                                      );
                                },
                              ),
                              ActionButton(
                                ...
                                onPressed: () {
                                  widget.actionHandler
                                      .onPromptTemplatesRestoreRequested(
                              ...
                              ActionButton(
                                ...
                                onPressed: () {
                                  widget.actionHandler
                                      .onPromptTemplatesDeleteRequested(
                                        _idController.text.trim(),
                                      );
                                },
                              ),
