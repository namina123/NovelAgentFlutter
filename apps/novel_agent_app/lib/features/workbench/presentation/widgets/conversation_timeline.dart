...
class ConversationTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (entries.isEmpty && !isGenerating && footer == null) {
      ...
      child: Scrollbar(
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final generatingIndex = entries.length;
            if (showGeneratingPlaceholder && index == generatingIndex) {
              return Container(
