...
void main() {
  test('resolveHfvvWave2LaneIds keeps canonical order and supports filtering', () {
    expect(
...
TaskCenterViewData _taskCenterViewData({
  ...
  return TaskCenterViewData(
    ...
    defaultChapterLength: const TaskCenterChapterLengthConfigViewData.fallback(),
    actionGroups: const [],
    guidanceRevisitBody: '',
  );
}
