...
class RunCenterSummaryRenderer {
  RunCenterSummaryRenderer({StopDiagnosisTextService? stopDiagnosisTextService})
  ...
  List<String> renderLines(JsonMap contract) {
    ...
    if (stopDiagnosis.present) {
      ...
      lines.add(_stopDiagnosisTextService.renderGenericReasonLine(reason));
