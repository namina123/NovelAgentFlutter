...
void main() {
  group('Narrative reference contracts', () {
    test('source ref preserves unknown source type during round-trip', () {
      ...
      expect(
        (source.toJson()['metadata'] as Map<String, Object?>)['confidence_hint'],
        'low',
      );
    });
    ...
    test('narrative ref and evidence ref preserve open ref types', () {
      ...
      expect(evidence.toJson()['evidence_type'], NarrativeEvidenceTypes.toolCall);
      expect(
    ...
    test('tool round evidence supports asset segment and external snippet refs', () {
      ...
      expect(toolRoundEvidence.toolRoundRef.refType, NarrativeRefTypes.toolRound);
