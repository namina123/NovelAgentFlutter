...
final class BuiltinToolCatalog {
  static const List<BuiltinToolDefinition>
  definitions = <BuiltinToolDefinition>[
    ...
    BuiltinToolDefinition(
      id: NarrativeDomainToolNames.requestExternalResearch,
      name: '请求外部研究',
      description: '只提出受控的外部研究请求；真正联网仍受权限策略与宿主平台能力约束，不默认无约束执行。',
      platformPolicy: ToolPlatformPolicy.desktopOrGatewayOnly,
      enabledByDefault: false,
    ),
    BuiltinToolDefinition(
      id: NarrativeDomainToolNames.submitResearchNote,
      name: '提交研究笔记',
      description:
          '提交结构化 research note，保存来源、citation、usable facts 与 creative suggestions，不直接联网。',
    ),
    BuiltinToolDefinition(
      id: NarrativeDomainToolNames.proposeKnowledgeCard,
      name: '提出知识卡',
      description: '提出项目知识卡提案，保持开放 payload，不把未知题材或文化类型写死成枚举。',
    ),
    BuiltinToolDefinition(
      id: NarrativeDomainToolNames.proposeDesignElement,
      name: '提出设计元素',
      description: '提出作品巧思、符号系统或结构设计提案，让设计元素以一等结构化结果进入信息层。',
    ),
    BuiltinToolDefinition(
      id: NarrativeDomainToolNames.linkInformationEvidence,
      name: '链接信息证据',
      description:
          '在 knowledge、design、research、reference 与 claim 之间建立结构化链路，不依赖正文提示词记忆。',
    ),
    BuiltinToolDefinition(
      id: NarrativeDomainToolNames.proposeReferenceWork,
      name: '提出引用作品边界',
