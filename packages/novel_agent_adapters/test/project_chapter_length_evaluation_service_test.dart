...
void main() {
  group('ProjectChapterLengthEvaluationService', () {
    ...
    test(
      'evaluates current chapter against recent chapter distribution',
      () async {
        ...
        expect(
          ValueReaders.intValue(evaluation['rolling_average_length']),
          2150,
        );
        expect(
          ValueReaders.stringValue(evaluation['recommended_action']),
          isNotEmpty,
        );
      },
    );
