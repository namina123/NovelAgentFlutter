...
void main() {
  group('GatewayFactoryResolver', () {
    test('resolves provider protocol to the matching gateway implementation', () {
      final tempRoot = Directory.systemTemp.createTempSync('novel_agent_gateway_factory');
      addTearDown(() {
    ...
    test('supports Gemini OpenAI-compatible and native as distinct gateways', () {
      ...
      expect(openAiCompatibleGateway.runtimeType, isNot(nativeGateway.runtimeType));
    });
  });
}
