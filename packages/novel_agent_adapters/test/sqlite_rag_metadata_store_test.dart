...
void main() {
  group('SqliteRagMetadataStore', () {
    test(
      'initializer creates rag metadata tables and bootstrap values',
      () async {
        ...
        try {
          ...
          try {
            ...
            expect(
              ...
              SqliteRagMetadataStore.schemaVersion,
            );
            expect(metadata['metadata_policy'], 'metadata_and_mapping_only');
            expect(
              metadata['vector_backend_policy'],
              'external_or_placeholder_only',
            );
