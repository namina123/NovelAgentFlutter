...
class BuiltinExpressionConstraintProfileRegistrationService {
  ...
  static const List<JsonMap> _rawProfiles = <JsonMap>[
    <String, Object?>{
      ...
      'rules': <Object?>[
        '少用工整排比、假深刻总结和万能收束句。',
        '正文不要用 Markdown 分割线、装饰性小标题或清单式结构来替代叙事推进，除非用户明确要求这种格式。',
        '压低破折号承担解释、转折和补充说明的频率；能改成动作、停顿、对话或短句时，不连续堆叠破折号。',
        '减少“不是……而是……”“不是因为……”“并非……”等模板化对照句，优先写出可观察的动作、后果和人物反应。',
        '少把“行，……”“行, ……”这类突兀口头起手句当作轻松感捷径；人物真要口头化时，先让语气、动作和上下文把口吻托住。',
